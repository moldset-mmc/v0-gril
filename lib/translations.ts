...
export const translations = {
  ru: {
    ...
    order: {
      ...
      items: "Блюд в заказе",
      table: "Номер стола",
      tableHint: "Например, 7",
      comment: "Комментарий к заказу",
      commentHint: "Например: соус отдельно",
      submit: "Отправить заказ",
      sending: "Отправляем…",
      clear: "Очистить заказ",
      requiredTable: "Укажите номер стола от 1 до 99",
      error: "Не удалось отправить заказ. Корзина сохранена — попробуйте ещё раз.",
      success: "Заказ отправлен",
      successHint: "Сотрудники получили заказ. Если потребуется уточнение, они подойдут к вашему столу.",
